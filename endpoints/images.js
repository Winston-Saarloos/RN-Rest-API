...
async function ImagesV1(req, res) {
          ...
          filterValues.forEach((filter) => {
            ...
            switch (filterParts[0]) {
              ...
              case "U":
                ...
                var taggedPlayers = [];
                image.TaggedPlayerIds.forEach((player) => {
                  taggedPlayers.push(player);
                });
                if (
                  taggedPlayers.findIndex(
                    (player) => player == filterParts[1]
                  ) > -1 &&
              ...
              default:
                ...
                console.log(
                  "An error occured parsing filter type: " + filterType
                );
            }
          });
      ...
      switch (sort) {
        ...
        case 3: // Cheers Ascending
          imageData = imageData.sort(
            (a, b) => parseInt(a.CheerCount) - parseInt(b.CheerCount)
          );
          break;
        case 4: // Cheers Descending
          imageData = imageData.sort(
            (a, b) => parseInt(b.CheerCount) - parseInt(a.CheerCount)
          );
          break;
        case 5: // Comment Count Ascending
          imageData = imageData.sort(
            (a, b) => parseInt(a.CommentCount) - parseInt(b.CommentCount)
          );
          break;
        case 6: // Cheers Descending
          imageData = imageData.sort(
            (a, b) => parseInt(b.CommentCount) - parseInt(a.CommentCount)
          );
          break;
        default: //
          common.responseJson(
...
async function getGlobalImages(req, res) {
    //Possible Parameters
  //- Date
  //- Take
